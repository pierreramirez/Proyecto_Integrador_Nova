            ...
            <nav class="navbar">
                <div class="container" style="display:flex; align-items:center; justify-content:space-between;">
                    ...
                    <div class="nav-actions">
                        <a href="${pageContext.request.contextPath}/Vista/login.jsp" class="btn btn-primary btn-access">
                ...
                <div class="search-card">
                    ...
                    <form id="search-form" action="BuscarPasajes" method="post" class="modern-form">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label class="form-label"><i class="fas fa-flag-checkered"></i> Destino</label>
