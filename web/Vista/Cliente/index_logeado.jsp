...
<html lang="es">
    <head>
        ...
        <!-- Misma hoja de estilos e iconos que el index original -->
    ...
    <body>
            ...
            <nav class="navbar">
                <div class="container" style="display:flex; align-items:center; justify-content:space-between;">
                    <div class="nav-brand" style="display:flex; align-items:center; gap:10px;">
                        <img src="${ctx}/Imagenes/novas_logo.png" alt="NOVAS Logo" class="logo">
                    ...
                    <div class="nav-actions">
                        <!-- Si NO hay usuario en sesión mostramos el botón Acceder -->
                        ...
                        <!-- Si HAY usuario mostramos nombre + dropdown -->
                        <c:if test="${not empty sessionScope.user}">
                            <div class="user-dropdown" id="userDropdown">
                                ...
                                <div class="user-menu" id="userMenu" role="menu" aria-label="Menú usuario">
                                    <a href="${ctx}/PerfilServlet"><i class="fas fa-user-circle" style="width:16px;"></i> Mi perfil</a>

                                    <!-- <-- Aquí abrimos la vista de Mis compras (puedes cambiar a /MisComprasServlet si prefieres servlet) -->
                                    <a href="${ctx}/Vista/Cliente/mis_compras.jsp"><i class="fas fa-shopping-cart" style="width:16px;"></i> Mis compras</a>

                                    <a href="${ctx}/srvIniciarSesion?accion=cerrar"><i class="fas fa-sign-out-alt" style="width:16px;"></i> Cerrar sesión</a>
                                </div>
                            </div>
                        </c:if>
                    </div>
        ...
        <section class="destinations-section" id="destinos">
            <div class="container">
                ...
                <div class="destinations-grid">
                    <div class="destination-card" data-destino="arequipa" data-id="3">
                        <div class="destination-image">
                            <img src="${ctx}/Imagenes/arequipa.jpg" alt="Arequipa">
                            <div class="destination-overlay"><span class="destination-price">Desde S/ 45</span></div>
                        </div>
                    ...
                    <div class="destination-card" data-destino="cusco" data-id="4">
                        <div class="destination-image">
                    ...
                    <div class="destination-card" data-destino="chiclayo" data-id="5">
                        <div class="destination-image">
                    ...
                    <div class="destination-card" data-destino="trujillo" data-id="6">
                        <div class="destination-image">
        ...
        <script>
            ...
            (function () {
                ...
                document.addEventListener('click', function (e) {
                    if (userBtn.contains(e.target)) {
                        ...
                        userBtn.setAttribute('aria-expanded', !visible);
                    } else {
            ...
            // tarjetas clicables -> DestinoServlet
            (function () {
