...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet"
              ...
              integrity="sha512-1ycn6IcaQQ40/MKB4Imkb9y+0P0O5T1p6U6U5W1Dq+PEw24hTx5K5Z5qX6Ch12eDqO4MHDL/95B2S/bRrw5qQ=="
        ...
        <div class="container" style="padding:28px 12px;">
            ...
            <c:if test="${empty viajes}">
                <div class="alert alert-info"
                     style="padding:16px; border-radius:8px; background:#f4f7fb; border:1px solid #e0e6f0;">
                            ...
                            <div style="display:flex; justify-content:space-between; align-items:center;">
                                <div>
                                    <h3 style="margin:0; color:#243a8b;">
                                        Viaje #<c:out value="${v.idViaje}"/>
                                    </h3>
                                    <small style="color:#6b6b6b;">
                                        Bus ID: <c:out value="${v.idBus}"/>
                                    </small>
                                </div>

                                <div style="text-align:right;">
                                    <div style="font-weight:700; color:#e66b00;">
                                        S/ <c:out value="${v.precio}"/>
                                    </div>
                                    <div style="font-size:12px; color:#6b6b6b;">
                                        Estado: <c:out value="${v.estado}"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="display:flex; gap:12px; align-items:center; justify-content:space-between;">
                                ...
                                <div style="display:flex; flex-direction:column; gap:6px;">
                                    <a href="${pageContext.request.contextPath}/ReservaServlet?action=init&viajeId=${v.idViaje}"
                                       class="btn btn-primary" style="padding:8px 14px; border-radius:8px;">
                                        Reservar
                                    </a>

                                    <a href="${pageContext.request.contextPath}/VerAsientosServlet?viajeId=${v.idViaje}"
                                       class="btn btn-outline" style="padding:8px 14px; border-radius:8px;">
                                        Ver asientos
                                    </a>
                                </div>
                            </div>
