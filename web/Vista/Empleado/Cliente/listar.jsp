        ...
        <div class="d-flex align-items-start">
            ...
            <div class="col-10">
                ...
                <div class="container mt-4">
                    ...
                    <button type="button" class="btn btn-success mb-3" id="btnAgregar">➕ Nuevo Cliente</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm btnEditar"
                                                    ...
                                                    data-dni="${c.dni}"
                                                    data-fecha="${c.fechaNacimiento}"
                                                    data-telefono="${c.telefono}"
                                                    data-genero="${c.genero}">✏️ Editar</button>

                                            <a href="${pageContext.request.contextPath}/ClienteServlet?action=eliminar&id=${c.id}" class="btn btn-danger btn-sm"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formCliente" method="post" action="${pageContext.request.contextPath}/ClienteServlet">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="fechaNacimiento" id="editFecha" required>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="genero" id="editGenero" required>
